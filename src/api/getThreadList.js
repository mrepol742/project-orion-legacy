...
function formatThreadList(data) {
    return data.map((t) => {
        ...
        return {
            ...
            lastReadTimestamp: t.last_read_receipt && t.last_read_receipt.nodes.length > 0 ? (t.last_read_receipt.nodes[0] ? t.last_read_receipt.nodes[0].timestamp_precise : null) : null, // timestamp in miliseconds
